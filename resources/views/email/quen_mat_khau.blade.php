                          ...
                          <tbody>
                            <tr style="background:#2e3291">
                              <td style="line-height:25px;padding:10px 20px;text-align:center">
                                <h1 style="color:#fff;font-size:30px;text-align:center">Thông báo đăng nhập</h1>
                              </td>
                            </tr>
                          </tbody>
                        </table>
                              ...
                              <td colspan="2">
                                <div style="line-height:1.6">
                                  <div style="font-size:16px; display:block;">
                                    <p style="text-align: justify;">Tài khoản <b>{{ $info['email'] }}</b> đã yêu cầu lấy lại mật khẩu. Hãy nhấp vào <a href="{{ $info['link'] }}" style="text-decoration:none;"><b>đây</b></a> và nhập mật khẩu mới để hoàn tất.</p>
                                  </div>
                                </div>
                              </td>
                            </tr>
