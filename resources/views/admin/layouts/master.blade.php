...
<head>
  ...
  <link href="/template/plugins/fontawesome-iconpicker/fontawesome-iconpicker.min.css" rel="stylesheet" type="text/css">
...
{{-- <body class="fix-header show-sidebar hide-sidebar @yield('master.bodyclass')"> --}}
