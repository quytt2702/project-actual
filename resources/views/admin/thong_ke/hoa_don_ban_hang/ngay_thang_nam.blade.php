...
@section('master.title', 'Thống kê hóa đơn bán hàng theo ngày tháng năm')
@section('master.content')
<div id="modal-hd-ngay-thang-nam"></div>
<div class="row m-t-30">
  <div class="col-sm-12">
    <div class="white-box">
      <div class="box-title">THỐNG KÊ HÓA ĐƠN BÁN HÀNG THEO NGÀY THÁNG NĂM</div>
      <div class="row">
        <div class="col-sm-5">
      ...
      <div class="row">
        <div id="thong_ke_hoa_don_ngay_thang_nam">
        </div>
      </div>
    </div>
  </div>
