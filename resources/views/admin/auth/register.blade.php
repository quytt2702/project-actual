    ...
    <section id="wrapper" class="new-login-register">
        ...
        <div class="new-login-box">
            <div class="white-box">
                ...
                @endif
                <form class="form-horizontal new-lg-form" action="{{ route('admin.auth.store') }}" method="POST">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            <input name="password_confirmation" class="form-control" type="password" required="" placeholder="Confirm Password"> </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-12">
                            <div class="checkbox checkbox-primary p-t-0">
                                <input name="agree_terms" id="checkbox-signup" type="checkbox">
