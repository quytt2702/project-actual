<div class="panel">
  <div class="panel-heading">Xem lịch sử trao thưởng của đại lý tháng/năm</div>
            ...
            <tbody>
              ...
              @foreach($xemThangNamThuongDaiLy as $item)
                <tr>
                  ...
                  <td class="text-right">{{ $item->thang}} / {{ $item->nam}}</td>
                  <td class="text-center">{{ $item->doanh_thu}} VND</td>
