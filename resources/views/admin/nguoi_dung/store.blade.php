...
@section('master.title', 'Thêm mới người dùng')
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="sdt" placeholder="Phone/Số điện thoại">
                  </div>
                </div>
              </div>
              <!--/span-->
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <form class="form-group">
              ...
              <div id="gioi_tinh" class="radio-list">
                <label class="radio-inline p-0">
                  <div class="radio radio-info">
                    <input type="radio" name="gioiTinh" id="radio1" value="Nam" checked>
