<div id="sua_don_hang_modal" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: block;">
  <div class="modal-dialog" style="min-width: 80%">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        <h4 class="modal-title">Sửa hàng trong kho</h4>
      </div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-danger waves-effect waves-light" id="btnCapNhat" {{-- data-dismiss="modal" --}} data-code="{{ $id }}" >Cập nhật</button>
      </div>
    </div>
  </div>
</div>
