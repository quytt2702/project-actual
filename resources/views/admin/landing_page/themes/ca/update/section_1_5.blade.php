  ...
  <div class="selected-section__body">
    <div class="form-horizontal">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-12">
          <input name="data[{{ $section->hash }}][title]" type="text" name="title" class="form-control" placeholder="Tiêu Đề" value="{{ $section->title }}">
        </div>
      </div>
    ...
    <div class="form-group">
      ...
      @include('admin.landing_page.themes.ca.update.components.datetime_picker', [
        'section_name' => $section->code,
      ])
    </div>
    <hr>
