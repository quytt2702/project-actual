<div class="link__wrapper form-horizontal">
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input name="data[{{ $section->hash }}][links][content][]" class="form-control" placeholder="Nội Dung" value="{{ $link->content }}">
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-sm-2">Liên Kết</label>
    <div class="col-sm-10">
      <input name="data[{{ $section->hash }}][links][url][]" class="form-control" placeholder="Liên Kết" value="{{ $link->url }}">
    </div>
  </div>
  <div class="form-group">
