...
<div class="selected-section__wrapper">
  <div class="selected-section__toolbar">
    <div class="toolbar__wrapper">
      <div class="toolbar__handlebar">Section 10</div>
  ...
  <div class="selected-section__body">
    <div class="form-horizontal">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-12">
          <input type="text" name="data[{{ $section->hash }}][title]" class="form-control" placeholder="Tiêu Đề" value="{{ $section->title }}">
        </div>
      </div>
    ...
    @include('admin.landing_page.themes.ca.update.components.action_images', [
