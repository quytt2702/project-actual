...
<div class="form-horizontal">
  <div class="form-group">
    ...
    <div class="col-sm-9">
      <div class="input-group">
        <input id="icon_picker_{{ $iconPicker }}" type="text" name="data[{{ $section_name }}_{{ $sectionHash }}][icon_contents][icon][]" class="form-control icon-picker" placeholder="Chọn một biểu tượng">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">
      <input type="text" name="data[{{ $section_name }}_{{ $sectionHash }}][icon_contents][title][]" class="form-control" placeholder="Tiêu Đề">
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-sm-3">Nội Dung</label>
    <div class="col-sm-9">
      <textarea rows="3" class="form-control" name="data[{{ $section_name }}_{{ $sectionHash }}][icon_contents][content][]" placeholder="Nội Dung"></textarea>
    </div>
  </div>
  <div class="form-group">
