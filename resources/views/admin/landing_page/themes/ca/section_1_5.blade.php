...
<div class="selected-section__wrapper">
  <div class="selected-section__toolbar">
    <div class="toolbar__wrapper">
      <div class="toolbar__handlebar">Section 1.5</div>
  ...
  <div class="selected-section__body">
    <div class="form-horizontal">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-12">
          <input name="data[{{ $section_name }}_{{ $sectionHash }}][title]" type="text" name="title" class="form-control" placeholder="Tiêu Đề">
        </div>
      </div>
    ...
    <div class="form-group">
      ...
      @include('admin.landing_page.themes.ca.components.datetime_picker', [
        'section_name' => 'section_1_5',
      ])
    </div>
    <hr>
