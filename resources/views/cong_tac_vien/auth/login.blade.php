...
<section id="wrapper" class="login-register">
  <div class="login-box login-sidebar">
    <div class="white-box">
      <form class="form-horizontal form-material" id="loginform" action="{{ route('cong_tac_vien.auth.login') }}" method="POST">
        {{ csrf_field() }}
        {{-- <div href="javascript:void(0)" class="text-center db"><img src="/template/plugins/images/admin-logo-dark.png" alt="Home" /><br/><img src="/template/plugins/images/admin-text-dark.png" alt="Home" /></div> --}}
...
{{--         <div class="row">
      ...
      <form class="form-horizontal" id="recoverform" action="{{ route('cong_tac_vien.auth.forgot') }}" method="GET">
        {{ csrf_field() }}
        <div class="form-group ">
          <div class="col-xs-12">
        ...
        <div class="form-group ">
          <div class="col-xs-12">
            <input name="email_recover" class="form-control" type="text" required="" placeholder="Email">
          </div>
        </div>
        <div class="form-group text-center m-t-20">
          <div class="col-xs-12">
